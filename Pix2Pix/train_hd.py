...
from pix2pixhd import Generator, Discriminator
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for sample in stdout:
            ...
            D_x, real_features = net_D(real_batch, real_label, return_features=True)
            ...
            if global_step % disc_repeats == 0:
                ...
                D_G_z2, fake_features = net_D(fake_batch_1, real_label, return_features=True)
